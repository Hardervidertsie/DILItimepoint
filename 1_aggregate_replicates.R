...
## DILI annotation data
	...
	if(FALSE) {
		.dili <- DILI[, c(1, 2, 3, 6, 7, 8, 9, 10, 16, 17)]
		  .dili$DILIConcern[.dili$DILIConcern == 'N/A'] <- NA
		  .dili$dailyDose[.dili$dailyDose == 'N/A'] <- NA
		  .dili$logP[.dili$logP == 'N/A'] <- NA
		  .dili$metabCap[.dili$metabCap == 'N/A'] <- NA
		  .dili$cmax[.dili$cmax == 'N/A'] <- NA

		write.table(.dili, file = '/Users/Wouter/Desktop/latestDILI.txt', quote = FALSE, sep = ';', row.names = FALSE)

		wt_supp1 <- read.delim('/Users/Wouter/stack/ownCloud/TOX/ExperimentData/DILIscreen/weida_ruleoftwo_suppTable1.txt')[, 1:5]
		wt_supp2 <- read.delim('/Users/Wouter/stack/ownCloud/TOX/ExperimentData/DILIscreen/weida_ruleoftwo_suppTable2.txt')[, 1:4]
		wt_supp3 <- read.delim('/Users/Wouter/stack/ownCloud/TOX/ExperimentData/DILIscreen/weida_ruleoftwo_suppTable3.txt')[, 1:5]
	}
